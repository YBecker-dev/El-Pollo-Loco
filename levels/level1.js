...
function initLevel() {
  level1 = new Level(
    [new Chicken('normal'), new Chicken('normal'), new Chicken('normal'), new Chicken('small'), new Chicken('small'), new Endboss()],
    [new Cloud(), new Cloud()],
    ...
    [new Coin(300, 100), new Coin(500, 100), new Coin(700, 100), new Coin(900, 150), new Coin(1200, 100)],
    [
      new Bottle(400, 350),
      new Bottle(600, 350),
      new Bottle(800, 350),
